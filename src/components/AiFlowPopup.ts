...
import { getAiFlowSettings, setAiFlowSetting, isAnyAiProviderEnabled, type AiFlowSettings } from '@/services/ai-flow-settings';
...
export class AiFlowPopup {
  ...
  private updateStatus(settings: AiFlowSettings): void {
    const any = isAnyAiProviderEnabled();
    this.statusDot.className = 'ai-flow-status-dot';
    ...
    // Suppress unused variable warning — `any` is read to ensure correct import
    void any;
  }
